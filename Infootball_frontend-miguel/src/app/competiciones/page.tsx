...
// Colores por defecto para competiciones
const defaultColors: Record<string, string> = {
  ...
  "Champions League": "from-blue-800 to-indigo-900",
  "UEFA Champions League": "from-blue-800 to-indigo-900",
  "Copa Libertadores": "from-green-600 to-green-800",
  "Copa América": "from-yellow-600 to-yellow-800",
  "MLS": "from-red-500 to-blue-600"
};
...
export default function CompeticionesPage() {
  ...
  useEffect(() => {
    const fetchCompetitions = async () => {
      ...
      try {
        ...
        setCompetitionsData(transformedCompetitions);
      } catch (err) {
        console.error('Error fetching competitions:', err);
        setError('Error al cargar las competiciones. Verifica que el backend esté corriendo.');
      } finally {
        setLoading(false);
      }
    };
  ...
  const featuredCompetitions = competitionsData.filter(comp => comp.featured).slice(0, 4);
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {featuredCompetitions.length > 0 ? (
                    ...
                    <div className="relative h-[350px] overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-950 shadow-2xl">
                      ...
                      <div className="absolute inset-0">
                        <div
                          ...
                          style={{
                            backgroundImage: comp.backgroundImage ? `url(${comp.backgroundImage})` : undefined,
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          <div className="w-16 h-16 bg-gray-800/50 rounded-lg flex items-center justify-center overflow-hidden">
                            {comp.logoImage ? (
                              <img src={comp.logoImage} alt={comp.name} className="w-12 h-12 object-contain" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                            ) : (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-2xl font-bold mb-2">No hay competiciones destacadas</h3>
              <p className="text-gray-400">Las competiciones destacadas aparecerán aquí</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {regularCompetitions.length > 0 ? (
                  ...
                  <div className="group h-full bg-gradient-to-br from-gray-900 to-gray-950 rounded-xl overflow-hidden border border-gray-800 hover:border-green-500/50 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-green-500/10">
                    ...
                    <div className="relative h-40 overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        {comp.logoImage ? (
                          <img src={comp.logoImage} alt={comp.name} className="w-20 h-20 object-contain" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                        ) : (
                    ...
                    <div className="p-5">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div className="bg-gray-800/50 rounded-lg p-3">
                          ...
                          <p className="text-white font-semibold text-sm">{comp.teams}</p>
                        </div>
                      </div>
            ...
            <div className="text-center py-12">
              <div className="text-6xl mb-4">🏆</div>
              <h3 className="text-2xl font-bold mb-2">No hay competiciones</h3>
              <p className="text-gray-400">No se encontraron competiciones en esta categoría</p>
            </div>
          )}
        </div>
      </section>
